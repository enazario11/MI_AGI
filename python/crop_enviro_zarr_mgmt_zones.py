...
#NWA
nwa_full = gpd.read_file("data/enviro/nwa/nwa_full.gpkg") 
...
o2_nwa = o2_nwa.rio.write_crs(nwa_full.crs) #assign crs
o2_nwa = o2_nwa.rio.set_spatial_dims(x_dim="lon", y_dim="lat") #get spatial dims to be named same

o2_nwa_crop = o2_nwa.rio.clip(nwa_full.geometry, nwa_full.crs, drop=True) #crop to full hull
...
o2_nwa_crop_ds.to_netcdf("data/enviro/nwa/do/processed/o2_nwa_crop_mgmt_zone.nc", encoding = enc_o2_nwa)
...
temp_nwa = temp_nwa.rio.write_crs(nwa_full.crs) #assign crs
temp_nwa = temp_nwa.rio.set_spatial_dims(x_dim="lon", y_dim="lat") #get spatial dims to be named same

temp_nwa_crop = temp_nwa.rio.clip(nwa_full.geometry, nwa_full.crs, drop=True) #crop to full hull
...
temp_nwa_crop_ds.to_netcdf("data/enviro/nwa/temp/processed/temp_nwa_crop_mgmt_zone.nc", encoding = enc_temp_nwa)
...
sal_nwa = sal_nwa.rio.write_crs(nwa_full.crs) #assign crs
sal_nwa = sal_nwa.rio.set_spatial_dims(x_dim="lon", y_dim="lat") #get spatial dims to be named same

sal_nwa_crop = sal_nwa.rio.clip(nwa_full.geometry, nwa_full.crs, drop=True) #crop to full hull
...
sal_nwa_crop_ds.to_netcdf("data/enviro/nwa/salinity/processed/sal_nwa_crop_mgmt_zone.nc", encoding = enc_sal_nwa)

#NEP
nep_full = gpd.read_file("data/enviro/nep/nep_full.gpkg") 
...
#crop
minx, miny, maxx, maxy = nep_full.total_bounds
box = o2_nep.sel(lon=slice(minx, maxx), lat=slice(miny, maxy))

mask = regionmask.mask_geopandas(nep_full, box.lon, box.lat)
...
o2_nep_crop_ds.to_netcdf("data/enviro/nep/do/processed/o2_nep_crop_mgmt_zone.nc", encoding = enc_o2_nep)
...
temp_nep_crop_ds.to_netcdf("data/enviro/nep/temp/processed/temp_nep_crop_mgmt_zone.nc", encoding = enc_temp_nep)
...
sal_nep_crop_ds.to_netcdf("data/enviro/nep/salinity/processed/sal_nep_crop_mgmt_zone.nc", encoding = enc_sal_nep)
