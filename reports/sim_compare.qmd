...
#bass, agi
bass_agi_do <- ggplot(enviro_bass, aes(DO_atm, agi, fill = temp)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("DO (atm)") + 
  ylab("AGI") + 
...
bass_mod_agi_do <- lm(agi ~ DO_atm, data = enviro_bass); summary(bass_mod_agi_do)
...
#cod, agi
cod_agi_do <- ggplot(enviro_cod, aes(DO_atm, agi, fill = temp)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("DO (atm)") + 
  ylab("AGI") + 
...
cod_mod_agi_do <- lm(agi ~ DO_atm, data = enviro_cod); summary(cod_mod_agi_do)
