...
library(wesanderson)
library(patchwork)
source(here("c:/Users/nazar/Documents/Projects/MI_AGI/functions/oxy_demand_functions_rev.R"))
set.seed(0904)
...
enviro_sim <- enviro_sim %>% mutate(DO_mbar = DO_atm*1013.25)

DO_thresh <- quantile(enviro_sim$DO_mbar)[1]
...
### AGI ####
enviro_bass$agi_o2_demand <- OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 498.95, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8)
enviro_bass$agi <- enviro_bass$DO_mbar/enviro_bass$agi_o2_demand
hist(enviro_bass$agi, breaks = 7)
...
### AGI ####
enviro_cod$agi_o2_demand <- OxyDemand(Tpref = 12, PO2_thresh = DO_thresh, T_C = enviro_cod$temp, W = 39916.1, d = 0.700, K = 0.121, Linf = 148, LwA = 0.005, LwB = 3.185)
enviro_cod$agi <- enviro_cod$DO_mbar/enviro_cod$agi_o2_demand
...
enviro_bass$agi_o2_demand <- OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 700.4, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8)
hist(enviro_bass$agi_o2_demand, breaks = 3)

#min weight for species
enviro_bass$agi_o2_demand <- OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 193.7, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8)
hist(enviro_bass$agi_o2_demand, breaks = 3)
...
#max weight for species
enviro_cod$agi_o2_demand <- OxyDemand(Tpref = 12, PO2_thresh = DO_thresh, T_C = enviro_cod$temp, W = 473, d = 0.700, K = 0.121, Linf = 148, LwA = 0.005, LwB = 3.185)
hist(enviro_cod$agi_o2_demand, breaks = 4)

#min weight for species
enviro_cod$agi_o2_demand <- OxyDemand(Tpref = 12, PO2_thresh = DO_thresh, T_C = enviro_cod$temp, W = 79, d = 0.700, K = 0.121, Linf = 148, LwA = 0.005, LwB = 3.185)
hist(enviro_cod$agi_o2_demand, breaks = 4)
...
enviro_bass$agi_o2_demand <- OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 329.9, d = 0.700, K = 0.231, Linf = 39.8, LwA = 0.02661, LwB = 2.8)
hist(enviro_bass$agi_o2_demand, breaks = 3)

#min length for species -- min weight included in MI study
enviro_bass$agi_o2_demand <- OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 329.9, d = 0.700, K = 0.231, Linf = 22.1, LwA = 0.02661, LwB = 2.8)
hist(enviro_bass$agi_o2_demand, breaks = 3)
...
#max length for species -- max weight included in MI study
enviro_cod$agi_o2_demand <- OxyDemand(Tpref = 12, PO2_thresh = DO_thresh, T_C = enviro_cod$temp, W = 157.7, d = 0.700, K = 0.121, Linf = 39, LwA = 0.005, LwB = 3.185)
hist(enviro_cod$agi_o2_demand, breaks = 4)

#min length for species -- max weight included in MI study
enviro_cod$agi_o2_demand <- OxyDemand(Tpref = 12, PO2_thresh = DO_thresh, T_C = enviro_cod$temp, W = 157.7, d = 0.700, K = 0.121, Linf = 21, LwA = 0.005, LwB = 3.185)
hist(enviro_cod$agi_o2_demand, breaks = 4)
...
for(i in 1:length(Tpref_vect)){
  ...
  agi_o2_demand <- OxyDemand(Tpref = Tpref_temp, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 498.95, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8)
  
  agi <- enviro_bass$DO_mbar/agi_o2_demand
...
for(i in 1:length(Tpref_vect)){
  ...
  agi_o2_demand <- OxyDemand(Tpref = Tpref_temp, PO2_thresh = DO_thresh, T_C = enviro_cod$temp, W = 39916.1, d = 0.700, K = 0.121, Linf = 148, LwA = 0.005, LwB = 3.185)
  agi <- enviro_bass$DO_mbar/agi_o2_demand
...
emp_bass_test$agi_o2_demand <- OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = emp_bass_test$temp, W = 498.95, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8)
...
emp_cod_test$agi_o2_demand <- OxyDemand(Tpref = 12, PO2_thresh = DO_thresh, T_C = emp_cod_test$temp, W = 39916.1, d = 0.700, K = 0.121, Linf = 148, LwA = 0.005, LwB = 3.185)
...
enviro_bass_size <- enviro_bass %>%
  mutate(bass_lg_demand = OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 700.4, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8), 
         bass_lg_agi = DO_mbar/bass_lg_demand, 
         bass_sm_demand = OxyDemand(Tpref = 22, PO2_thresh = DO_thresh, T_C = enviro_bass$temp, W = 193.7, d = 0.700, K = 0.231, Linf = 34.1, LwA = 0.02661, LwB = 2.8), 
         bass_sm_agi = DO_mbar/bass_sm_demand)
...
#bass
enviro_bass$agi_normoxia <- 0.21*1013.25/enviro_bass$agi_o2_demand
...
#cod
enviro_cod$agi_normoxia <- 0.21*1013.25/enviro_cod$agi_o2_demand
...
#bass, mi
bass_mi_temp <- ggplot(enviro_bass, aes(temp, mi, fill = DO_mbar)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
...
#bass, agi
bass_agi_temp <- ggplot(enviro_bass, aes(temp, agi, fill = DO_mbar)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("Temperature (C)") + 
  ylab("AGI") + 
...
#cod, mi
cod_mi_temp <- ggplot(enviro_cod, aes(temp, mi, fill = DO_mbar)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("Temperature (C)") + 
  ylab("MI") + 
...
#cod, agi
cod_agi_temp <- ggplot(enviro_cod, aes(temp, agi, fill = DO_mbar)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("Temperature (C)") + 
  ylab("AGI") + 
...
```{r}
#| warning: false
#| label: bass, agi, mi, DO, scatter
#| fig-width: 10
#| fig-height: 5

#bass, mi
bass_mi_do <- ggplot(enviro_bass, aes(DO_kpa, mi, fill = temp)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("DO (kPa)") + 
  ylab("MI") + 
...
bass_mod_mi_do <- lm(mi ~ DO_kpa, data = enviro_bass); summary(bass_mod_mi_do)

#bass, agi
bass_agi_do <- ggplot(enviro_bass, aes(DO_mbar, agi, fill = temp)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("DO (atm)") + 
  ylab("AGI") + 
...
bass_mod_agi_do <- lm(agi ~ DO_mbar, data = enviro_bass); summary(bass_mod_agi_do)

bass_mi_do | bass_agi_do
```
...
```{r}
#| warning: false
#| label: cod, agi, mi, DO, scatter
#| fig-width: 10
#| fig-height: 5

#cod, mi
cod_mi_do <- ggplot(enviro_cod, aes(DO_kpa, mi, fill = temp)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("DO (kPa)") + 
  ylab("MI") + 
...
cod_mod_mi_do <- lm(mi ~ DO_kpa, data = enviro_cod); summary(cod_mod_mi_do)

#cod, agi
cod_agi_do <- ggplot(enviro_cod, aes(DO_mbar, agi, fill = temp)) + 
  stat_smooth(method = "lm", col = "steelblue4") +
  geom_point(size = 3, color = "black", shape = 21) + 
  xlab("DO (atm)") + 
  ylab("AGI") + 
...
cod_mod_agi_do <- lm(agi ~ DO_mbar, data = enviro_cod); summary(cod_mod_agi_do)

cod_mi_do | cod_agi_do
```
:::